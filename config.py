...
# --- Generation ---
# Primary backend: Qwen3-32B via Groq's free API tier. No cost, no credit
# card, ~30 req/min on the free tier. Chosen because Qwen3 scores highest of
# the tested open models on RAGAS faithfulness (0.91) — the metric that
# measures whether the model actually sticks to retrieved context instead of
# drifting into invented claims, which is exactly what this assignment is
# graded on. Requires a free API key: https://console.groq.com
#
